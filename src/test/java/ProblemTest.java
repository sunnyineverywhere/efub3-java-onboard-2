...
public class ProblemTest {
    ...
    class Problem6Test{
        ...
        @Test
        void case2(){
            Integer[][] values = {{1, 1, 0, 1}, {0, 0, 0, 0}, {1, 1, 1, 1}};
            List<String> answer = List.of("A", "D", "E");
            assertThat(Problem6.solution(values)).isEqualTo(answer);
        }
    }
    ...
    class Problem7Test{
        ...
        @Test
        void case3(){
            List<String> values = List.of("CHHAE", "WONNN", "1019", "chae", "won");
            String answer = "CW1cwHO0hoHN1anAN9eEN";
            assertThat(Problem7.solution(values)).isEqualTo(answer);
        }
    }
