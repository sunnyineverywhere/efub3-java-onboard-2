...
public class ProblemTest {
    ...
    class Problem6Test{
        ...
        @Test
        void case2(){
            Integer[][] values = {{0, 1, 1, 1}, {0, 1, 1, 0}, {0, 0, 0, 0}};
            List<String> answer = List.of("A", "B", "D");
            assertThat(Problem6.solution(values)).isEqualTo(answer);
        }
    }
    ...
    class Problem7Test{
        ...
        @Test
        void case3(){
            List<String> values = List.of("bBHHn3", "D345", "ghk11", "u8ro7", "k");
            String answer = "bDgukB3h8H4krH51on173";
            assertThat(Problem7.solution(values)).isEqualTo(answer);
        }
    }
    ...
    class Problem8Test{
        ...
        void case2(){
            ...
            Integer[][] locations = {{3, 10}, {20, 10}, {0, 3}, {7, 13}};
            Integer answer = 337;
            assertThat(Problem8.solution(paperNumber, locations)).isEqualTo(answer);
        }
    }
